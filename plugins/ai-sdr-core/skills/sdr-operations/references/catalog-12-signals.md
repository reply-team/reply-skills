...
| `trigger_run.list` | "What did my rules actually do last night" — which fired, on whom, what work came out, and what was held back by policy. | `read` | `reversible` | `auto` | nothing at stake | `none` | `none` | `not_applicable` | `not` |
