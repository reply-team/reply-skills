...
| `task.cancel` | "This work should not happen at all — drop it" | `control` | `compensatable` | `auto` | the task's state | `none` | `required` | `required` | `reports what it could not reach` |
