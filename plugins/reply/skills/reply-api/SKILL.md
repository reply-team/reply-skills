...
| 403/401 `TEAM_REQUIRED`·`TEAM_NOT_ACCESSIBLE`·`USER_REQUIRED`·`USER_NOT_FOUND` | team/user resolution | see auth-and-keys skill |
...
- `auth-and-keys` — scopes model and team/org resolution.
